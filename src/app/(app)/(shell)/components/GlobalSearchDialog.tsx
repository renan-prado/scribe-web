 ...
 *
 * Ele morava no `CollectionSearch`, a barra de busca de LISTA que os Estudos
 * usavam, e veio para cá quando aquela tela saiu do produto junto com o modo
 * estudo. É uma string sentinela e não `""` porque o `Select` do base-ui trata
 * vazio como "nada escolhido" e não desenha rótulo nenhum no gatilho.
 */
 ...
 * (aberta por `?busca=1`) e um link que as outras telas usavam para chegar até
 * ela. As duas viraram esta — um diálogo por cima de QUALQUER tela, sem
 * navegar para `/home` primeiro. A barra de lista dos Estudos usava o mesmo
 * padrão, e saiu junto com o resto das telas do modo estudo.
 *
 ...
 *
 * ## O motor é o mesmo da Biblioteca
 *
 ...
 * `groupLabel` ("Esta semana", "Semana passada", o mês). Ela vira uma segunda
 * forma de navegar o acervo, não só de procurar nele.
 *
...
export function GlobalSearchDialog() {
  ...
  // Sem filtro nenhum, a lista É o acervo — recente primeiro, agrupado.
  // Ver "Sem filtro nenhum..." acima.
