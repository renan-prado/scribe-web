...
import { Composer } from "../_editor/Composer";

export const metadata: Metadata = { title: "Escrever" };

/**
 * `/summary/new`, a folha em branco.
 *
 ...
 * URL para `/summary/<id>/edit` sem navegar. Então este endereço dura um instante,
 ...
 * dentro.
 *
 * **A barra é a do `/import` e a do `/summary`**: um voltar no lugar do
 ...
 * "A busca do editor" no `Composer`. O `/summary/[id]/edit` monta a mesma barra.
 */
