...
export default async function FinanceOverviewPage() {
  ...
  const blocking =
    usdBrl === null
      ? [
          "Sem cotação do dólar. Informe uma à mão no selo de cotação de /admin/costs, sem ela, todo valor em US$ fica fora dos totais.",
        ]
      : [];
    ...
    <div className="flex flex-col gap-6">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        <ListCard title="Recorrentes" subtitle="Compromisso mensal">
          ...
          <QuickLink href="/admin/finance/recurring">Ver custos recorrentes</QuickLink>
        </ListCard>
        ...
        <ListCard title="Caixa" subtitle="Sobrevivência">
          ...
          <QuickLink href="/admin/settings?tab=finance">Configurações</QuickLink>
        </ListCard>
      </section>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <ListCard title="O que ainda devemos" subtitle="Compromissos">
          ...
          <QuickLink href="/admin/finance/entries?view=open">Ver o que está em aberto</QuickLink>
        </ListCard>
        ...
        <ListCard title="Últimos 12 meses" subtitle="Acumulado em competência">
          ...
          <div className="flex flex-wrap gap-2">
            <QuickLink href="/admin/finance/entries">Lançamentos</QuickLink>
            <QuickLink href="/admin/finance/scenarios">Projeções</QuickLink>
          </div>
        </ListCard>
      </section>
      ...
      <p className="flex items-start gap-2 text-[11.5px] font-light leading-[1.55] text-scriba-ink-mute">
        ...
        <span>
          ...
          /admin/costs. O que se lança à mão aqui é só o que ninguém mede por nós.
        </span>
      </p>
    </div>
  );
