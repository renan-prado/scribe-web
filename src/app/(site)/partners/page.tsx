 ...
 *
 * O regulamento detalhado é `/partners/terms`, e ele é a versão que
 * vale: esta página resume, aquela obriga.
 */

/**
 * O CTA não vai direto para `/sign-in`: passa por `/partners/join`, que
 ...
 */
const PROSPECT_ENTRY = "/partners/join";
    ...
    <div className="flex flex-col gap-3 rounded-[26px] bg-scriba-paper p-5 sm:p-6">
      ...
      <div className="flex flex-col gap-3 rounded-[18px] border border-scriba-hairline-soft p-4">
        ...
        <div className="grid grid-cols-3 gap-3">
          {/* Espelha o funil real de `/partners/dashboard`: taxa em relação ao degrau
