 ...
 * /admin/custos. O câmbio manual, pela mesma razão, continua no selo que
...
const TABS = ["produto", "financeiro"] as const;
...
const TAB_SUBTITLES: Record<Tab, string> = {
  produto: "Quais funcionalidades cada plano libera, o kill switch e as exceções por pessoa.",
  financeiro: "O vocabulário das categorias e os parâmetros que o painel usa para calcular.",
};
...
export default async function AdminSettingsPage({
  ...
  const tab: Tab = TABS.includes(sp.aba as Tab) ? (sp.aba as Tab) : "produto";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <AdminTabs
        tabs={TABS.map((key) => ({
          href: key === "produto" ? "/admin/configuracoes" : `/admin/configuracoes?aba=${key}`,
