 ...
 * de `loadAdminUsageSummary`, ou seja, /admin/custos com filtro fixo de 30
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
        ...
        <div className="flex flex-wrap gap-2">
          <QuickLink href="/admin/custos">Custos e margem</QuickLink>
          <QuickLink href="/admin/metricas">Funil e ativação</QuickLink>
          <QuickLink href="/admin/financeiro">Financeiro</QuickLink>
        </div>
