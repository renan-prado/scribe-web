  ...
  return {
    rules: {
      ...
      disallow: [
        ...
        // proposital: é a URL da ficha das lojas, e uma URL que o robots manda
        // ignorar é uma URL que ninguém encontra quando precisa dela (o Google
        // resolve pelo caminho mais longo, então o allow vence).
        "/home",
        "/recording",
        "/summary",
        "/import",
