 ...
 *
 *   node src/scripts/release.mjs                # deriva o degrau dos commits
 *   node src/scripts/release.mjs minor          # força o degrau
 *   node src/scripts/release.mjs --dry-run      # mostra e não escreve nada
 *
...
// src/scripts/release.mjs → src/scripts → src → a raiz do repositório.
