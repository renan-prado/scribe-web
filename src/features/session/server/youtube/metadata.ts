 ...
 * Martins. Ver `src/features/session/server/prompts/youtube-metadata.ts` para por que isto não é uma
 * regex.
 *
...
import { YOUTUBE_METADATA_SYSTEM_PROMPT } from "@/features/session/server/prompts/youtube-metadata";
