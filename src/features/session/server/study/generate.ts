import "server-only";
import { STUDY_ANSWERS_SYSTEM_PROMPT } from "@/features/session/server/prompts/study-answers";
import {
  STUDY_QUESTION_FILTER_SYSTEM_PROMPT,
  STUDY_THESIS_CHECK_SYSTEM_PROMPT,
} from "@/features/session/server/prompts/study-guard";
import { STUDY_QUESTIONS_SYSTEM_PROMPT } from "@/features/session/server/prompts/study-questions";
import { STUDY_WRITE_SYSTEM_PROMPT } from "@/features/session/server/prompts/study-write";
import {
  renderTheologianBriefing,
  theologiansFor,
} from "@/features/session/server/prompts/theologians";
import { anchorReferences, renderAnchoredPassages } from "@/features/session/server/study/anchor";
import { resolveCovers } from "@/features/session/server/study/covers";
import { sealStudy } from "@/features/session/server/study/seal";
 ...
 *
 * Os dois passos do guardião (`src/features/session/server/prompts/study-guard.ts`) existem contra o
