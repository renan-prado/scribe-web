...
export function StudyCtaCard({
  ...
  return (
    <article className="relative my-2 flex flex-col items-stretch gap-3 overflow-hidden rounded-[24px] border border-scriba-ink-strong/20 bg-scriba-blue-soft/70 p-6 shadow-[0_2px_10px_rgba(79,168,240,0.08)] sm:flex-row sm:pl-6 sm:pr-2">
