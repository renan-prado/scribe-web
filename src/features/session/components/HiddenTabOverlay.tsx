...
export function HiddenTabOverlay({ onDismiss }: { onDismiss: () => void }) {
  return (
    ...
    >
      <span className="flex size-12 items-center justify-center rounded-full bg-scriba-blue-soft text-scriba-blue">
        <AlertTriangle className="size-5" strokeWidth={2.2} />
      </span>
      <div className="flex flex-col items-center gap-2">
        <p
          id="hidden-tab-title"
          className="font-heading text-base font-semibold text-scriba-ink-strong"
        >
      ...
      <button
        ...
        onClick={onDismiss}
        className={cn(
          "rounded-full bg-scriba-blue px-5 py-2.5 text-[11px] font-semibold uppercase tracking-wider text-white shadow-[0_5px_14px_rgba(79,168,240,0.32)] transition-colors outline-none",
