 ...
 * usuário espera cerca de dois minutos; dizer o que está acontecendo transforma
 ...
 * servidor não reporta em que etapa está. Os valores vêm das latências que
 * aparecem no log de cada passo. Se a geração terminar antes, o overlay some
 * no meio de uma fase; se demorar mais, a última fica de pé — por isso a
 * última é a única frase escrita para envelhecer parada.
 *
