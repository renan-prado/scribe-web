    ...
    <div className="relative flex min-h-svh w-full flex-col overflow-hidden bg-[image:var(--lp-hero-auth)] font-[var(--font-poppins),system-ui,sans-serif] text-scriba-ink-strong">
      ...
      <header className="relative z-10 flex items-center justify-between px-5 py-5 sm:px-10 sm:py-6">
        <Link
          ...
          className="flex items-center gap-2 rounded-full transition-opacity hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40"
        >
          {/* Mesma divisão do LandingLogo: pena azul (decorativa, fora da
              regra de contraste) e palavra em ink-strong, que inverte com o
              tema. Ver o comentário em LandingChrome.tsx. */}
          <svg
            aria-hidden="true"
          ...
          <span
            className="text-[22px] font-semibold leading-none text-scriba-ink-strong"
