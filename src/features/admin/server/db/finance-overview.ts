...
import {
  ...
  type MeasuredInputs,
} from "@/features/admin/finance/aggregate";
import { todayIso } from "@/features/admin/finance/recurrence";
import type {
  FinanceCategory,
  FinanceEntry,
  FinanceRecurring,
 ...
 *
 * Existe para que as seis telas de `/admin/finance` não repitam a mesma
 ...
 *
 * O câmbio vem de `getUsdToBrl()`, o MESMO de `/admin/costs`, com o mesmo
