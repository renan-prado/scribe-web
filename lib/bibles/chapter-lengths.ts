 ...
 *
 * Generated by scripts/generate-chapter-lengths.ts. Do NOT edit by hand — the
 * source of truth is lib/bibles/NVI.json.
 */
...
export const CHAPTER_VERSE_COUNTS: Record<string, number[]> = {
  ...
  Rt: [22, 23, 18, 22],
  "1Sm": [
    28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 43, 15, 23, 29, 22,
  ...
  Jo: [51, 25, 36, 54, 47, 71, 53, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42, 31, 25],
  At: [
  ...
  "3Jo": [15],
  Jd: [25],
  Ap: [20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 18, 18, 20, 8, 21, 18, 24, 21, 15, 27, 21],
};
