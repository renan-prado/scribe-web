...
- **session:** o resumo cortado pelo filtro do provedor deixa de virar sessão vazia (`45c8d6c`)
...
- **app:** o disco do puxar-para-atualizar ficava preso no topo da tela (`b1a4b67`)
...
- **youtube:** cacheia a legenda por vídeo para não buscá-la duas vezes (`d01ac90`)
