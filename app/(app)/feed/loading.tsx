export default function HomeLoading() {
  return (
    <div className="flex flex-1 flex-col bg-scriba-surface">
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-6 px-4 py-6 sm:gap-8 sm:px-6 sm:py-8">
        ...
        <div className="flex flex-col gap-4 rounded-[24px] border border-scriba-hairline-soft bg-scriba-paper p-6 shadow-[0_6px_22px_var(--scriba-shadow)]">
