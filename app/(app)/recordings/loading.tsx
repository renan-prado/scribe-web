...
export default function ListLoading() {
  return (
    <div className="flex flex-1 flex-col bg-scriba-surface">
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-6 px-4 py-6 sm:gap-8 sm:px-6 sm:py-8">
                ...
                {["a", "b", "c"].map((itemKey, i) => {
                  ...
                  return (
                    <li
                      ...
                      className="rounded-3xl border border-scriba-hairline-soft bg-scriba-paper p-5 shadow-[0_4px_14px_var(--scriba-shadow-soft)] sm:p-6"
                    >
